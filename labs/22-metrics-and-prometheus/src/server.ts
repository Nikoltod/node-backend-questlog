import { ApplicationState, buildApp } from "./app";
import { closeDatabasePool, registerDatabasePoolErrorHandler } from "./database";
import { setTimeout as delay } from "node:timers/promises";
import { setApplicationShuttingDown } from "./metrics";
